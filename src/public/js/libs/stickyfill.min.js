...
!function (a, b) {
  ...
  function k() {
    for (var a = H.length - 1; a >= 0; a--)if (H[a].inited) {
      var b = Math.abs(t(H[a].clone) - H[a].docOffsetTop), c = Math.abs(H[a].parent.node.offsetHeight - H[a].parent.height);
      if (b >= 2 || c >= 2)return !1
    }
    return !0
  }
  ...
  function q(a) {
    ...
    var b = a.node.nextSibling || a.node, c = a.clone.style;
  ...
  function s(a) {
    var b = getComputedStyle(a), c = a.parentNode, d = getComputedStyle(c), f = a.style.position;
  ...
  function u(a) {
    ...
    return {doc: {top: c.top + b.pageYOffset, left: c.left + b.pageXOffset}, win: c}
  }
  ...
  var F, G, H = [], I = !1, J = a.documentElement, K = function () {
  }, L = "hidden", M = "visibilitychange";
