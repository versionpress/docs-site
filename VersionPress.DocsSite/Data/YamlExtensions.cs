...
namespace VersionPress.DocsSite.Data
{
    ...
    /// <summary>
    /// Based on https://github.com/Code52/pretzel/blob/master/src/Pretzel.Logic/Extensions/YamlExtensions.cs
    /// </summary>
    public static class YamlExtensions
    {
        static readonly Regex r = new Regex(@"(?s:^---(.*?)---)");

        public static IDictionary<string, object> YamlHeader(this FileInfo fileInfo, bool skipHeader = false)
        {
            return YamlHeader(File.ReadAllText(fileInfo.FullName), skipHeader);
        }
